...
int main () {   cout <<"Let's learn about references and constants!" <<'\n' ;
             ...
             // if you create a reference, you will modify both if you modify either the original object or the ref
             ...
             // you can modify the original object only by modifying it directly or it references (not const ref)
