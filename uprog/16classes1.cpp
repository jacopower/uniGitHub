...
class book2 {  public:  string title ;
                        string author ;
                        int pages ;
                        book2(string atitle, string aauthor, int apages)   {  title=atitle ;    // in () there are 3 vaiables, so when i create an objet of this type i need to put argments in ()
                                                                              author=aauthor ;
                                                                              pages=apages ; 
                                                                           }
            } ;
