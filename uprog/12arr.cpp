...
int main()  {   
            ...
            /* a[] ={1, 3, 91, 22, 64, 30} ;       // error, once i create the array i have to initialize the single components like a[n]=x
            ...
            /* when you create an array, in the braces there is the actual number of elements it will contain (1 to infinity) ;
               when you call the array, in the braces there is the position of the element you are referring to (0 to infinity)*/
